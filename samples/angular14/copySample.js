...
// we want to copy the sample file (here Sample.angular) from @twicpics/components-sample package
// into app.component.html file
const sampleSource = resolve( ``, `node_modules`, `@twicpics/components-sample`, `Sample.angular` );
const sampleDest = resolve( __dirname, `src`, `app`, `app.component.html` );
