...
> [!NOTE]
> TwicPics Components are available for `Svelte3` version **3.47+**. If you are using `Svelte4`, you can find their documentation [here](https://github.com/TwicPics/components/blob/0.26.0/documentation/svelte4.md).
