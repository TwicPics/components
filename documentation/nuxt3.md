...
TwicPics components for `Nuxt3` come as a `Nuxt3 Module` and are configured as [such](https://v3.nuxtjs.org/guide/features/modules#modules).
...
`TwicImg`, `TwicPicture`, and `TwicVideo` are available in your templates as long as you have [configured the TwicPics Nuxt3 Module](#setting-up-twicpics-components-into-your-nuxt3-project).
