...
> If you are using `Svelte3` or `Svelte5`, you can find their documentation [here](__GITHUB_BLOB_PATH__/documentation/svelte3.md) and [here](__GITHUB_BLOB_PATH__/documentation/svelte5.md) respectively.
