...
// the correct functionality of the "to" property in the TwicVideo component.
...
components.forEach( component => {
    ...
    testCases.push( {
        description: `${ component.name } should render attributes when using to and from `,
        fn: async ( page, port ) => {
            const params = {
              component: component.name,
              src: getSrc( component.name ),
