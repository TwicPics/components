...
components.forEach( component => {
    ...
    testCases.push( {
        description: `${ component.name } should not render any id attribute when empty is passed`,
        fn: async ( page, port ) => {
            const params = {
              component: component.name,
              src: getSrc( component.name ),
    ...
    testCases.push( {
        description: `${ component.name } should not render any id attribute when invalid is passed`,
        fn: async ( page, port ) => {
            const params = {
              component: component.name,
              src: getSrc( component.name ),
